    ...
    <section className="py-20 lg:py-28">
      <div className="container mx-auto px-4 lg:px-8">
        ...
        >
          ...
          <motion.div
            className="absolute top-0 right-0 w-96 h-96 bg-primary rounded-full blur-3xl opacity-10"
            animate={{ scale: [1, 1.2, 1], x: [0, 30, 0] }}
            transition={{ duration: 8, repeat: Infinity, ease: "easeInOut" }}
          />
          <motion.div
            className="absolute bottom-0 left-0 w-64 h-64 bg-primary rounded-full blur-3xl opacity-10"
          ...
          <div className="relative z-10">
            <motion.h2
              className="text-3xl lg:text-5xl font-extrabold text-background mb-6"
