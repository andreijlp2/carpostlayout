        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-8 items-center">
          ...
          <div>
            ...
            <motion.h1
              ...
              className="text-2xl sm:text-3xl md:text-4xl lg:text-[3.5rem] font-extrabold font-heading leading-[1.3] sm:leading-[1.25] lg:leading-[1.2] text-white mb-6 drop-shadow-lg"
            >
