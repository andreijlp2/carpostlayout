  ...
  return (
    <section className="relative bg-hero-gradient pt-28 pb-0 sm:pt-36 lg:pt-44 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        />
        <motion.div
          className="absolute top-[60%] left-[8%] w-6 h-6 bg-white/10 rounded-full"
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <div>
            ...
            <motion.h1
              ...
              className="text-3xl sm:text-4xl md:text-5xl lg:text-[3.5rem] font-extrabold font-heading leading-[1.1] text-white mb-6 drop-shadow-lg"
            >
            ...
            <motion.p
              ...
              className="text-base sm:text-lg text-white/80 max-w-lg mb-8 leading-relaxed"
            >
            ...
            >
              <motion.div whileHover={{ scale: 1.05, y: -2 }} whileTap={{ scale: 0.97 }}>
                <Button
                  size="xl"
                  className="bg-cta text-cta-foreground hover:brightness-110 shadow-cta font-bold rounded-full px-8"
                >
                  Começar Agora
              ...
              <motion.div whileHover={{ scale: 1.05, y: -2 }} whileTap={{ scale: 0.97 }}>
                <Button
                  size="xl"
                  className="border-2 border-white/30 bg-white/10 backdrop-blur-sm text-white hover:bg-white/20 hover:border-white/50 font-semibold rounded-full px-8"
                >
          ...
          >
            <motion.img
              ...
              className="w-full max-w-lg lg:max-w-xl drop-shadow-[0_20px_60px_rgba(100,60,240,0.3)]"
              animate={{ y: [0, -15, 0] }}
